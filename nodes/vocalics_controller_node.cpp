...
int main(int argc, char** argv)
{
  ...
  nh.param("/vocalics_controller/spl_to_volume_beta0", g_spl_to_volume_beta0, 0.0);
  nh.param("/vocalics_controller/spl_to_volume_beta1", g_spl_to_volume_beta1, 0.0);
  nh.param("/vocalics_controller/spl_to_volume_beta2", g_spl_to_volume_beta2, 0.0);
  nh.param("/vocalics_controller/volume_to_spl_beta0", g_volume_to_spl_beta0, 0.0);
  nh.param("/vocalics_controller/volume_to_spl_beta1", g_volume_to_spl_beta1, 0.0);
  nh.param("/vocalics_controller/volume_to_spl_beta2", g_volume_to_spl_beta2, 0.0);
